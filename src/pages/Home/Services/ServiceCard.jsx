...
const ServiceCard = ({ title, description, highlight }) => {
    return (
        ...
        hover:bg-emerald-200 border-x-lime-500npm install react-fast-marquee
        transition duration-300 ease-in-out ${highlight ? "bg-lime-200 text-black" : "bg-white text-gray-800"
                }`}
        >
